...
## Tiered MVP Definition (FDR-003)

**Strategic Context**: As of 2026-02-01, the founder has decided on a tiered market entry approach (FDR-003):

### Tier Definitions

| Tier | Name | Launch Timing | Scope |
|------|------|---------------|-------|
| **Tier 1** | Minimal (Launch MVP) | Months 1-6 | Companionship only, standard personal data, voluntary DBS |
| **Tier 2** | Standard (Full MVP) | Months 6-12 | Personal care, skill-based matching, mandatory DBS |
| **Tier 3** | Enhanced | Months 12-18 | Condition-specific matching, live-in care, health data with consent |
| **Tier 4** | Comprehensive | Months 18+ | Care coordination, full health data, B2B integration |

### Important Distinctions

**"MVP" in this document** refers to the **Tier 2 MVP** (full personal care marketplace) - this represents the complete feature set for a functioning care marketplace with personal care services.

**Actual market entry** begins with **Tier 1 MVP** (companionship only) - a strategically reduced scope to minimize compliance investment before product-market fit validation.

### Tier 1 Criteria (Launch MVP)

A system is **Tier 1 MVP** if it:
- Does NOT require special category data (Article 9)
- Does NOT require DBS verification (companionship is not regulated activity)
- Does NOT require care skills or medical condition matching
- Can operate with companionship services only
- Provides core economic loop (search, book, pay, review)

### Tier 2 Criteria (Full MVP)

A system is **Tier 2 MVP** if it meets the original classification criteria below (regulatory compliance, safeguarding, core economic loop, operational viability).

**See**: [Tiered Market Entry Roadmap](../../../ROADMAP.md) for complete tier specifications, compliance requirements, and progression gates.

---

## Classification Criteria (Tier 2 MVP)
