...
**Version**: 2.0 - Regulated Healthcare Marketplace
...
- **Supply**: Independent individual caregivers (no agencies)
- **Payments**: On-platform only
- **Regulatory environment**: CQC-relevant, regulated care
- **Primary constraint**: Clinical safety > growth > UX convenience
- **Safeguarding**: Platform has safeguarding liability for vulnerable adults
...
### 1.1 Care Receiver Registration
...
### 1.2 Family Member Registration
...
### 1.3 Caregiver Registration
- Professional caregiver account creation
- Email and phone verification
- Profile wizard (personal details, photo, bio, experience)
- Service definition (personal care, companionship, live-in)
- Medical condition experience declaration
- Care skills and qualifications listing
- Hourly rate setting (within platform range)
- Service radius configuration
- Bank account setup for payouts
- Right to work declaration
- Terms of service acceptance (self-employed status)
...
### 1.7 Multi-Factor Authentication (2FA)
...
## 2. Caregiver Capability & Verification System

### 2.1 Medical Condition Experience Profile
...
### 2.3 Qualifications & Training Registry
...
### 2.4 Employment History & Experience
...
### 2.5 Service Type Definition
- Services caregiver offers:
  - Companionship (conversation, activities)
  - Personal care (washing, dressing, toileting)
  - Mobility assistance
  - Meal preparation and feeding
  - Medication assistance (prompting only, non-clinical)
  - Overnight care
  - Live-in care (weekly/monthly bookings)
  - Dementia support
  - End-of-life companionship
  - Light housework and cleaning
  - Shopping and errands
  - Transportation (if caregiver has vehicle)
- Service type risk assessment (personal care flagged for enhanced checks)

### 2.6 Capability Verification Workflow
...
### 2.7 Capability-Based Search Indexing
- Searchable/filterable caregiver capabilities
- Medical condition matching algorithm
- Care skills matching algorithm
- Qualification-level filtering
- Experience-level filtering

---

## 3. Medical Condition & Care Skills Matching

### 3.1 Care Receiver Care Needs Profile
...
### 3.2 Medical Condition Matching Engine
...
### 3.3 Care Skills Matching Engine
...
### 3.4 Qualification Requirement Enforcement
- Personal care bookings require minimum NVQ Level 2 or Care Certificate
- Certain conditions (dementia, Parkinson's) recommend specific training
- Live-in care requires enhanced qualifications
- System blocks bookings if qualification requirements not met

### 3.5 Risk Assessment & Care Plan Upload
...
## 4. Discovery & Advanced Search

### 4.1 Basic Location-Based Search
...
- Filter by medical condition experience (multi-select)
- Filter by care skills (multi-select)
- Filter by qualifications (Care Certificate, NVQ 2/3, nursing background)
- Filter by service type (personal care, companionship, live-in)
...
- Filter by caregiver rating (minimum star rating)
...
### 4.4 Caregiver Profile Visibility Rules
- Only show caregivers with verified capabilities matching care receiver needs
- Hide caregivers without required qualifications for personal care
- Prioritize caregivers with relevant medical condition experience
- Deactivate profiles if verification expires
...
## 5. Booking System (Hourly, Daily, Live-In)

### 5.1 Booking Types
- **Hourly bookings**: Minimum 2 hours, maximum 8 hours per session
- **Daily care**: Full-day bookings (8-12 hours)
- **Multi-day bookings**: Consecutive days (e.g., weekend care)
- **Live-in care**: Weekly or monthly bookings with overnight stays
- **Overnight care**: Single overnight session (10pm-8am example)
- **Recurring bookings**: Weekly recurring sessions (e.g., every Tuesday 2-5pm)

### 5.2 Booking Request Creation
- Select caregiver from search or profile
- Choose booking type (hourly, daily, live-in)
...
- Attach care plan or risk assessment (optional)
- Specify medical conditions and care skills required
...
### 5.3 Booking Request Review (Caregiver)
...
### 5.4 Booking Acceptance & Payment Capture
...
### 5.5 Booking Lifecycle & Status Management
...
## 7. Payment System & Escrow

### 7.1 Care Receiver Payment Setup
...
## 8. Reviews, Ratings & Reputation

### 8.1 Post-Booking Reviews (Care Receiver → Caregiver)
...
## 9. Safeguarding & Incident Management

### 9.1 Safeguarding Reporting System
...
## 10. Identity & Background Verification

### 10.1 Care Receiver Identity Verification
...
### 13.6 CQC (Care Quality Commission) Compliance Preparation
- CQC registration decision (is platform a regulated activity?)
- CQC-aligned policies and procedures:
  - Safeguarding adults policy
  - Dignity and respect policy
  - Complaints and compliments policy
  - Infection control policy (COVID-19)
...
- Regulatory submissions (ICO, HMRC, CQC if applicable)
...
## 14. Emergency Escalation & Response
...
## 15. Calendar & Availability Management
...
## 17. Caregiver Dashboard & Management
...
## 21. Content Management & Education
