...
export default function ICareAppNavbar({ navItems, noShadow = false, compactDesktopNav = false }) {
    ...
    return (
        <>
            ...
            >
                ...
                <nav className={`${styles.desktopNav} ${compactDesktopNav ? styles.desktopNavCompact : ""}`.trim()}>
                    {items.map((item) =>
                        !item.children ? (
                            <NavLink
                                key={item.to}
