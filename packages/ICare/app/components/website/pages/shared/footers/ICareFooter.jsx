                ...
                <div className={styles.topGrid}>
                    ...
                    <div className={styles.col}>
                        ...
                        <nav aria-label="Footer links" className={styles.links}>
                            <Link to="/" className={styles.navLink} style={{ color: "#000" }}>
                                Home
                            </Link>
                            <Link to="/how-it-works" className={styles.navLink} style={{ color: "#000" }}>
                                How it works
                            </Link>
                            <Link to="/terms" className={styles.navLink} style={{ color: "#000" }}>
                                Terms
                            </Link>
                            <Link to="/privacy" className={styles.navLink} style={{ color: "#000" }}>
                                Privacy Policy
                            </Link>
                            <Link to="/cookies" className={styles.navLink} style={{ color: "#000" }}>
                                Cookies
                            </Link>
                            <Link to="/contact" className={styles.navLink} style={{ color: "#000" }}>
                                Contact
                            </Link>
                        </nav>
                    </div>
