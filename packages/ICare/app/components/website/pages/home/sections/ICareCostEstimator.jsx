 ...
 *
 * MVP/Legal tweaks:
 * ✅ "ICare total" -> "Estimated with ICare" (platform wording)
 * ✅ Agency tooltip clarifies "market estimate" + "varies by provider"
 * ✅ Live-in hourly note: comparison only
 * ✅ NLW note: "for reference only"
 * ✅ Removed stray "ate"
 */
export default function ICareCostEstimator({
    ...
    // ✅ Soft lead (email me this estimate) - kept but unused for now
        ...
        <section aria-label="Cost estimator" style={wrap}>
            ...
            <div style={container}>
                ...
                <div className="icare-est-cards" style={cardsRow}>
                    ...
                    <div style={card}>
                        ...
                        <div style={{ marginTop: 30, color: TEXT, fontWeight: 600, fontSize: "1.1rem" }}>
                            You may save around{" "}
                            <span style={{ color: "rgb(119, 141, 67)", fontWeight: 950 }}>
                                {Math.round(savePct)}%
                            </span>{" "}
                        ...
                        {/* ✅ MVP-safe live-in clarification */}
                        <div style={microNote}>
                ...
                <div style={avgPayBox}>
                    ...
                    <strong>1 April 2026</strong> is <strong>£12.71/hour</strong> (21+){" "}
                    <strong>(for reference only)</strong>.<br /> Some market guides also describe live-in as{" "}
