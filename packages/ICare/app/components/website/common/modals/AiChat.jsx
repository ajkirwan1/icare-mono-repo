...
export default function AiChat() {
    ...
    const MOBILE_LAUNCHER_BOTTOM = "26px";
        ...
        <>
            ...
            {open && (
                <div
                    ...
                    style={{
                        ...
                        maxHeight: expanded
                            ? "min(86vh, 780px)"
                            : (isMobile ? `calc(100dvh - ${MOBILE_CHAT_TOP} - ${MOBILE_CHAT_BOTTOM})` : "none"),
                        background: "#fff",
            ...
            <style>{`
                ...
                @media (max-width: 760px) {
                    ...
                    .icare-chat-launcher-wrap--visible {
                        animation: icareLauncherFadeIn 220ms ease-out forwards;
                    }

                    @keyframes icareLauncherFadeIn {
                        from { opacity: 0; }
                        to { opacity: 1; }
                    }
