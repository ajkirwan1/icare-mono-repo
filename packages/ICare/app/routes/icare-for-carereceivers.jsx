    ...
    return (
        <div style={{ fontFamily: "system-ui,-apple-system,Helvetica,Arial,sans-serif" }}>
            <section style={heroWrap} aria-label="Who We Are hero">
                ...
                <div style={content}>
                    <h1 style={title}>ICare for Carereceivers</h1>
                    <p style={lead}>
                        Find caregivers with skills that
                        match your needs
                        <p style={lead}>Manage everything in one place</p>
                        <p style={lead}>Free registration - no subscription</p>
