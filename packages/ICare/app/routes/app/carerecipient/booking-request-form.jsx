...
async function loadPaymentMethodCount(apiBase) {
  if (!apiBase) { return SAMPLE_DATA.paymentMethodCount; }
...
export async function loader({ params, request }) {
  ...
  const paymentMethodCount = noPaymentOverride ? 0 : await loadPaymentMethodCount(API_BASE);
...
export async function action({ request, params }) {
  ...
  return {
    ok: true,
    successMessage: "Booking request sent. Caregiver has 24 hours to respond.",
    ...
    <main className="booking-detail-page">
      ...
      <div className="booking-shell booking-request-shell">
        ...
        {paymentMethodCount === 0 ? (
          <section className="booking-alert booking-alert--warning" role="alert" aria-live="assertive">
            ...
            <div className="booking-alert-actions">
              <ActionLink to="/carerecipient/account/my-account" label="Add Payment Method" />
            </div>
          </section>
        ) : null}
        ...
        <section className="booking-card booking-request-caregiver-summary">
          ...
          <button type="button" className="booking-request-profile-link booking-request-profile-button">
            View Profile ›
          </button>
        </section>
