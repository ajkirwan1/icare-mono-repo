...
export default function WhoWeAre() {
    ...
    return (
        <div style={{ fontFamily: "system-ui,-apple-system,Helvetica,Arial,sans-serif" }}>
            <section style={heroWrap} aria-label="How it works hero">
                <img src={whoWeAreHeroSrc} alt="Care coordination background" style={heroImg} />
                ...
                <div style={content}>
                    <h1 style={title}>How it works</h1>
                    <p style={lead}>
                        Why choose ICare instead of going through an agency?

                        <p>Unlike traditional agencies, we don’t charge high margins
                            for matching or management.</p>
                        <p>That means you save money, and the caregiver earns more</p>
            ...
            <h1 style={title}>ICare can help bypass several agencies, saving everyone money</h1>
            <section aria-label="Mission pillars" style={sectionShell}>
                {[
                    {
                        t: "Registration is simple and free",
                        d: "Registering an account is simple, free, and safe. You will only need to provide limited and non-sensitve information to create an account, explore our app, and connect with a caregiver or someone who needs care."
                    },
                    {
